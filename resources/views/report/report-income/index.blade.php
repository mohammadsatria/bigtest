             ...
             <div class="col-md-10 col-md-offset-2">
                 <form class="form-horizontal form-label-left" name="reportIncomeForm" id="reportIncomeForm">
                   <div class="item form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dateFrom">Date From (d/m/y)
                     </label>
                     <div class="col-md-3">
                   ...
                   <div class="item form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dateTo">Date To (d/m/y)
                     </label>
                     <div class="col-md-3">

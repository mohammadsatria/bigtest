      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" name="userForm" id="userForm" data-parsley-validate="">
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="setting">Setting <span class="required">*</span>
              </label>
              <div class="col-md-4">
                <input type="text" value="{{ $data->info }}" id="setting" setting="setting" class="form-control col-md-4" maxlength="50" />
              </div>
            </div>

            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Value <span class="required">*</span>
              </label>
              <div class="col-md-4">
